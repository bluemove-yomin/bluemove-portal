        ...
        blocks = [
            {
                ...
                "text": {
                    "type": "plain_text",
                    "text": "⚠ '블루무브 가입 지원' 페이지 지원서 관련 오류 발생",
                },
            },
            {
                "type": "section",
                "text": {
                    "type": "mrkdwn",
                    "text": "사용자가 '블루무브 가입 지원' 페이지에서 지원서 관련 작업을 요청하였으나 오류가 발생했습니다.",
                },
            },
            {
                "type": "section",
            ...
            {"type": "divider"},
            {
                ...
                "elements": [
                    {
                        "type": "mrkdwn",
                        "text": "ℹ️ 이 메시지는 사용자가 위 URI에서 지원서 관련 작업을 요청하였으나 오류가 발생하여 발송되었습니다.",
                    },
                ],
            },
        ]
